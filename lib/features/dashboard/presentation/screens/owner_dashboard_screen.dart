...
class OwnerDashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final userName = authState.userName ?? 'Owner';
    ...
    return ResponsiveScaffold(
      appBar: AppBar(
        title: Text('$company - Admin Portal'),
        elevation: 0,
        backgroundColor: theme.colorScheme.surface,
        iconTheme: IconThemeData(color: theme.colorScheme.onSurface),
        actions: const [
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildDesktopWelcomeCard(theme, userName, company, isDark),
                        const SizedBox(height: AppSizes.p24),
                        Text('Operations Analytics',
                            style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                        const SizedBox(height: AppSizes.p12),
                        _buildDesktopStatsGrid(context, stats),
                        ...
                        Text('Recent Activity',
                            style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                        const SizedBox(height: AppSizes.p12),
                        _buildDesktopRecentActivity(context, theme, stats.recentActivities),
                      ],
                    ),
                  ),
                ),
    ...
    return ListView(
      ...
      children: [
        ...
        MobileHeroCard(
          ...
          subtitle: 'Manage $company operations.',
        ...
        // KPI Stats grid
        Text('Operations Overview', style: MobileText.sectionStyle(context)),
  ...
  Widget _buildMobileQuickActions(BuildContext context) {
    final actions = [
      ...
      _ActionData('Billing', Icons.receipt_long_rounded, Colors.deepPurple, () => context.push('/billing')),
  ...
  // ─── Desktop widgets (unchanged) ─────────────────────────────────────────
  Widget _buildDesktopWelcomeCard(ThemeData theme, String userName, String company, bool isDark) {
    return Container(
      width: double.infinity,
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text('SYSTEM OWNER OVERVIEW',
                ...
                Text(
                    'Manage employees, inventory, sales, production, and track daily updates for $company.',
  ...
  Widget _buildDesktopStatsGrid(BuildContext context, DashboardStatsData stats) {
    final columns = ResponsiveLayout.isTablet(context) ? 3 : 4;
    final cards = [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(color: card.color.withAlpha(30), shape: BoxShape.circle),
  ...
  Widget _buildDesktopQuickActions(BuildContext context) {
    final columns = ResponsiveLayout.isTablet(context) ? 3 : 6;
    final actions = [
      _ActionData('Add Employee', Icons.person_add_alt_1_rounded, Colors.blue, () => context.push('/employees/add')),
      _ActionData('Add Purchase', Icons.add_shopping_cart_rounded, Colors.teal, () => context.push('/purchase/add')),
      _ActionData('Add Production', Icons.add_box_rounded, Colors.purple, () => context.push('/production/create')),
  ...
  Widget _buildDesktopRecentActivity(BuildContext context, ThemeData theme, List<ActivityItem> activities) {
    if (activities.isEmpty) {
      return Card(
        elevation: 0,
        shape: RoundedRectangleBorder(
        ...
        child: const Padding(
            ...
            child: Center(child: Text('No recent activity records found.'))),
      );
    }
    return Card(
      elevation: 0,
